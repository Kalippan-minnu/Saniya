...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Saniya voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel Saniya özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'Saniya yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Saniya yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Saniya, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Saniya, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Saniya features. Turn your account into a ai chatbot!'
    already_on = 'Saniya artificial intelligence is already fully functional.'
    already_off = 'Saniya artificial intelligence is currently running semi-functional.'
    succ_on = 'Saniya Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Saniya Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
